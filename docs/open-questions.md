...
— Rifts folded into the Gate, the contest on contested frontier worlds ([[Gates|Gates]] FRONTIER-1); **no sealed/fail-closed Gate state and no re-key** — home protection is being hard to find (a decaying share-trail) + relocation + bounded loss ([[gates|Gates]] GATE-2, [[coordinates|Coordinates & Obscurity]]).
