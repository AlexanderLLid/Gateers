...
The place-types of Gaters, kept high-level this phase (src:
raw/design-overview.md). [tentative]
...
megastructure / Supergate sites.

## Open questions
- The network's true extent (one system / many / galaxies).
- Whether any type warrants its own page yet.
