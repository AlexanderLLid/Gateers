...
description: The protocol for handling conflicts between new content and existing pages, for both canon and mechanics. The agent reaches for this during ingest, editing, and lint whenever a fact may conflict with an existing page.
---
...
```
Surface it in the next /lint report until resolved.
